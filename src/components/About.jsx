...
export default function About() {
  ...
  return (
    <section id="about" className="relative py-24 px-6 bg-gradient-to-br from-dark via-dark to-orange-950/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative flex justify-center lg:justify-start">
            ...
            <div className="relative w-full max-w-md">
              ...
              {/* Image */}
              <div className="rounded-3xl overflow-hidden border border-gray-800 shadow-2xl h-[500px] lg:h-[600px] bg-dark-secondary transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-orange-500/30">
                <img
                  src={portraitImage}
              ...
              <div className="absolute top-8 -right-4 space-y-3 z-10">
                {technologies.map((tech, index) => (
                  ...
                  >
                    <div className="px-4 py-2 bg-dark-secondary border border-orange-500/50 rounded-full backdrop-blur-md hover:border-orange-400 hover:scale-110 hover:shadow-lg hover:shadow-orange-500/30 transition-all duration-300">
                      <span className="text-sm font-semibold text-orange-300">{tech}</span>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="flex flex-col justify-center">
            ...
            {/* CTA Button */}
            <div>
              <button className="px-8 py-4 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-orange-500/40">
                Let's Work Together
              </button>
            </div>
          </div>
